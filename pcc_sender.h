...
class  PccSender
 ...
 private:
  ...
  void EnterProbing();
  // Set the sending rate to the central rate used in PROBING mode in PCC Vivace.
  void EnterProbing_vivace(const std::vector<UtilityInfo>& utility_info);
  ...
  QuicBandwidth ComputeRateChange(const std::vector<UtilityInfo>& utility_info) const;
